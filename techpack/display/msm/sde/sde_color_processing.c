...
#endif
int oldret = 0; //fix bug【2966726】Colour Weakness 1.0
				...
				struct sde_crtc *hw_crtc)
{
	...
	if(cstate->fingerprint_mode == 0 && oldret == 1){
		usleep_range(20* 1000, 30 * 1000 + 100);
		pr_info("PCC Delay 20ms cysoplus_oldret =%d\n ",oldret);
	}
