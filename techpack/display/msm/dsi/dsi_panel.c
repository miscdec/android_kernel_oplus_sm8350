...
static int dsi_panel_power_on(struct dsi_panel *panel)
{
	...
	if (!strcmp(panel->oplus_priv.vendor_name, "NT37701"))
	...
	u32 bl_lvl)
{
	...
	if (!drm_enc) {
		SDE_ERROR("Invalid params drm_enc null\n");
		return -EINVAL;
	}
...
const char *cmd_set_state_map[DSI_CMD_SET_MAX] = {
	...
	"qcom,mdss-dsi-hbm-start-0-switch-command-state",
	"qcom,mdss-dsi-hbm-start-1-switch-command-state",
	"qcom,mdss-dsi-hbm-start-2-switch-command-state",
	"qcom,mdss-dsi-hbm-end-0-switch-command-state",
	"qcom,mdss-dsi-hbm-end-1-switch-command-state",
	"qcom,mdss-dsi-hbm-end-2-switch-command-state",
	"qcom,mdss-dsi-hbm-end-3-switch-command-state",
